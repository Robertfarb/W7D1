...
/******/ 	return __webpack_require__(__webpack_require__.s = "./frontend/todos.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    ...
    case _todo_actions.RECEIVE_TODOS:
      return [].concat(_toConsumableArray(state)).concat(action.todos);
    default:
      return state;
  }
};
...
var _store = __webpack_require__(/*! ./store/store */ "./frontend/store/store.jsx");
